...
////////////////////////////////////////////////////////////////////////
module  etr_sdram_ctrl
(
    input   wire            sys_clk         ,   //系统时钟
    input   wire            sys_rst_n       ,   //复位信号，低电平有效
//SDRAM写端口
    input   wire            sdram_wr_req    ,   //写SDRAM请求信号
    input   wire    [22:0]  sdram_wr_addr   ,   //SDRAM写操作的地址
...
//SDRAM读端口
    ...
    input   wire    [22:0]  sdram_rd_addr   ,   //SDRAM读操作的地址
...
//********************************************************************//
//------------- sdram_init_inst -------------
etr_sdram_init  sdram_init_inst
(
...
//------------- sdram_arbit_inst -------------
etr_sdram_arbit sdram_arbit_inst
(
...
//------------- sdram_a_ref_inst -------------
etr_sdram_a_ref sdram_a_ref_inst
(
    .sys_clk     (sys_clk   ),  //系统时钟,频率100MHz
    .sys_rst_n   (sys_rst_n ),  //复位信号,低电平有效
    .init_end    (init_end  ),  //初始化结束信号
...
//------------- sdram_write_inst -------------
etr_sdram_write sdram_write_inst
(
    .sys_clk        (sys_clk        ),  //系统时钟,频率100MHz
    .sys_rst_n      (sys_rst_n      ),  //复位信号,低电平有效
    .init_end       (init_end       ),  //初始化结束信号
...
//------------- sdram_read_inst -------------
etr_sdram_read  sdram_read_inst
(
    .sys_clk        (sys_clk        ),  //系统时钟,频率100MHz
    .sys_rst_n      (sys_rst_n      ),  //复位信号,低电平有效
    .init_end       (init_end       ),  //初始化结束信号
