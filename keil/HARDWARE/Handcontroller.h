...
#define DI   ((GPIOB->DATA)>>8)%2        //PA0  输入

#define DO_H GPIO_SetOutput(GPIOB,DO_Pin)        //命令位高
#define DO_L GPIO_ClrOutput(GPIOB,DO_Pin)        //命令位低

#define CS_H GPIO_SetOutput(GPIOB,CS_Pin)       //CS拉高
#define CS_L GPIO_ClrOutput(GPIOB,CS_Pin)       //CS拉低

#define CLK_H GPIO_SetOutput(GPIOB,CLK_Pin)       //时钟拉高
#define CLK_L GPIO_ClrOutput(GPIOB,CLK_Pin)      //时钟拉低
