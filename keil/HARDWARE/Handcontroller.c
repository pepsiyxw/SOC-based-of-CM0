...
void PS2_Init(void)
{
	GPIO_InitTypeDef Controller;
	Controller.GPIO_AltFun = GPIO_Pin_Null;
	Controller.GPIO_IRQ = GPIO_IRQ_NULL;
	Controller.GPIO_Pin = CLK_Pin|CS_Pin|DO_Pin;
	GPIO_Init(GPIOB,&Controller);
}
/**************************************************************************
函数功能：向手柄发送命令
入口参数：CMD指令
